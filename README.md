...
[![Build Status](https://travis-ci.org/s-rah/onionscan.svg?branch=onionscan-0.2)](https://travis-ci.org/s-rah/onionscan) [![Go Report Card](https://goreportcard.com/badge/github.com/caramel-juni/onionscan-v3links)](https://goreportcard.com/report/github.com/caramel-juni/onionscan-v3links)
...
See <a href="https://github.com/caramel-juni/onionscan-v3links/wiki">the wiki</a> for guidance.

### Grab with go get

`go get github.com/caramel-juni/onionscan-v3links`

### Compile/Run from git cloned source

Once you have cloned the repository into somewhere that go can find it you can
run `go install github.com/caramel-juni/onionscan-v3links` and then run the binary in `$GOPATH/bin/onionscan`.

Alternatively, you can just do `go run github.com/caramel-juni/onionscan-v3links.go` to run without compiling.
